...
public class Ejercicio_6_App {
	...
	public static void main(String[] args) {
		...
		datos_Proveedores[0] = "'1D5E', 'tornillo'";
		datos_Proveedores[1] = "'1R7T', 'martillo'";
		datos_Proveedores[2] = "'2V6R', 'destornillador'";
		datos_Proveedores[3] = "'3M4N', 'llave inglesa'";
		datos_Proveedores[4] = "'8Z5L', 'taladro'";
		...
		// Cerrar conexion MySqlConnectionHandler.closeConnection(con_handler);
